...
export class CategoriesApi {
   ...
   */
  static async getCategorySubcategories(categoryId: number) {
    return apiClient.get(
   ...
   */
  static async updateSubcategory(id: number, data: { name?: string; categoryId?: number }) {
   ...
   */
  static async getCategoryStats(id: number) {
    return apiClient.get(
